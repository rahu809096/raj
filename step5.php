         ...
         <div class="row">
            ...
            <div class="col-md-5">
               <div class="card m-0 p-0">
                  ...
                  <div class="card-body">
                     <form action="save_data5.php" method="post">
                        <div class="row">
                           <div class="col-md-12">
						     ...
						     <div class="col-md-12"> 
                              <input type="text" class="form-control" name="adhhar" placeholder="Enter Adhaar numer" =""> 
                           </div>
                           <h4><b>OR</b></h4>
						    <div class="col-md-12"> 
                              <input type="text" class="form-control" name="pan" placeholder="Enter PAN numer" =""> 
                           </div>
